...
for directory in (DATA_DIR, RAW_DATA_DIR, PROCESSED_DATA_DIR, STAGING_DIR, METADATA_DIR, LOG_DIR, MODELS_DIR, REPORTS_DIR):
...
ENDPOINTS = {
    "declarations": {
        ...
        "select": [
            "id", "disasterNumber", "state", "incidentType",
            "declarationDate", "incidentBeginDate", "incidentEndDate",
            "declarationType", "fipsStateCode", "fipsCountyCode", "lastRefresh",
        ],
    },
    "public_assistance": {
        ...
        "select": [
            ...
            "mitigationAmount", "gmProjectId", "gmApplicantId", "lastRefresh", "hash",
        ],
    },
    "disaster_summaries": {
        ...
        "select": [
            ...
            "paLoadDate", "iaLoadDate", "hash", "lastRefresh", "id",
        ],
    },
}
