...
Outputs: direct_data_streaming/data/processed/climate_aggregated.parquet
         direct_data_streaming/data/raw/noaa/StormEvents_details-*.csv.gz (cached)
"""
...
# PATHS
# ─────────────────────────────────────────────
_HERE    = Path(__file__).resolve().parent          # .../src/ingestion
